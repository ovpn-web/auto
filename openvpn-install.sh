...
echo -e "${RED} #        AUTOSCRIPT CREATED BY ─━═ LunDy PreCh═━─         #    "
echo -e "${RED} #      -----------About Us------------         #    "
echo -e "${RED} #    OS  DEBIAN 7-8-9  OS  UBUNTU 14-16-18     #    "
echo -e "${RED} #       Truemoney Wallet : ─━═094-849-7673═━─        #    "
echo -e "${RED} #               { VPN / SSH }                  #    "
echo -e "${RED} #         BY : ─━═ LunDy PreCh═━─               #    "
echo -e "${RED} #    FB : ─━═freenetvpndtac═━─       #    "
echo -e "${RED} =============== OS-32 & 64-bit =================    "
...
wget -q -O /usr/bin/pass https://ovpnpro.000webhostapp.com/Script/install/openvpn/PassKey.txt
...
END
	...
	echo "<pre>by Lundy Prech KHMERNET | LUNDY PRECH</pre>" > /home/vps/public_html/index.html
...
echo ""
	cd /usr/local/bin
wget -q -O m "https://raw.githubusercontent.com/ovpn-web/auto/main/menu-sm.sh"
chmod +x /usr/local/bin/m
	wget -O /usr/local/bin/Auto-Delete-Client "https://raw.githubusercontent.com/ovpn-web/auto/main/Auto-Delete-client"
